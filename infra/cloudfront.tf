...
resource "aws_cloudfront_distribution" "site" {
  ...
  default_cache_behavior {
    ...
    # index.html and other root files: short TTL so deploys propagate quickly
    min_ttl     = 0
    default_ttl = 300
    max_ttl     = 86400
  }

  # Cache CSS and JS longer — Vite content-hashes these filenames
  ...
  # SPA routing: return index.html for any 403/404 from S3 so client-side router handles the path
